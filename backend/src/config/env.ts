...
const envSchema = z.object({
  ...
  // Device-bound signed offline capability configuration.
  POS_OFFLINE_CAPABILITY_TTL_DAYS: z.coerce
    .number()
    .int()
    .min(1)
    .max(30)
    .default(7),
  POS_OFFLINE_PRIVATE_KEY_BASE64: z.string().min(1).optional(),
  POS_OFFLINE_PUBLIC_KEY_BASE64: z.string().min(1).optional(),
