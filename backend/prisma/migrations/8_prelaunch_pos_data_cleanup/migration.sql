-- One-time pre-launch cleanup of POS trial data.
-- Catalog, users, restaurant settings, dining-table configuration, and paired
-- POS devices are intentionally preserved.
BEGIN;
