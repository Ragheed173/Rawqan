...
export async function checkoutLocal(input: { orderId: string; userId: string; businessDate: string; payments: { method: "CASH"; amountMinor: string; tenderedMinor: string }[] }) {
  ...
  return localOperation("FINALIZE_INVOICE", payload, [posDb.invoices, posDb.invoiceLines, posDb.invoiceModifiers, posDb.orderItemModifiers, posDb.payments, posDb.orders, posDb.orderTables, posDb.restaurantTables], async () => {
...
export async function finalizeLocalEqualSplit(input: { orderId: string; userId: string; businessDate: string; splitCount: number; payments?: { method: "CASH"; amountMinor: string; tenderedMinor: string }[][] }) {
  ...
  return localOperation("FINALIZE_EQUAL_SPLIT", payload, [posDb.invoices, posDb.invoiceAllocationLines, posDb.invoiceAllocationModifiers, posDb.orderItemModifiers, posDb.payments, posDb.orders, posDb.orderTables, posDb.restaurantTables], async () => {
...
export async function payLocalInvoice(input: { invoiceId: string; userId: string; method: "CASH"; amountMinor: string; tenderedMinor?: string }) {
  ...
  return localOperation("CREATE_PAYMENT", payload, [posDb.invoices, posDb.payments, posDb.orders, posDb.orderTables, posDb.restaurantTables], async () => {
